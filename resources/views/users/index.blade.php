    ...
    <div class="row my-2 justify-content-center d-flex sub-level">
        <div class="col-md-5">
            ...
            <form action="send-message" method="post">
                @csrf
                <h4>From:</h4>
                <input type="text" class="form-control my-1" name = "from" value = "chris@mail.com" readonly>
                <h4>To:</h4>
                <input type="text" class="form-control my-1" name = "to" value = "muga@mail.com" readonly>
                <br>
